...
\begin{codigosimple}{latex}{Sintaxis: Marco Teórico}
...
\begin{codigosimple}{latex}{Sintaxis: infobox}
\begin{infobox}
...
\begin{codigosimple}{latex}{Sintaxis: successbox}
\begin{successbox}
...
\begin{codigosimple}{latex}{Sintaxis: warningbox}
\begin{warningbox}
...
\begin{codigosimple}{latex}{Sintaxis: dangerbox}
\begin{dangerbox}
...
\begin{codigosimple}{latex}{Sintaxis: tipbox}
\begin{tipbox}
...
\begin{codigosimple}{latex}{Sintaxis: notebox}
\begin{notebox}
...
\begin{codigosimple}{latex}{Sintaxis: titlebox}
...
\begin{codigosimple}{latex}{Sintaxis: definitionbox}
...
\begin{codigosimple}{latex}{Sintaxis: examplebox}
...
\begin{codigosimple}{latex}{Sintaxis: importantbox}
\begin{importantbox}
...
\begin{codigosimple}{latex}{Sintaxis: checklist}
\begin{checklist}
...
\begin{itemize}
  ...
  \item Implementar funcionalidad básica.
...
\begin{codigosimple}{latex}{Sintaxis: proscons}
\begin{itemize}
  \item Ventaja: fácil de implementar.
  \item Ventaja: buena documentación.
  \item Inconveniente: requiere configuración adicional.
  \item Inconveniente: curva de aprendizaje inicial.
\end{itemize}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: steplist}
\begin{enumerate}
  \\item Primer paso.
  \\item Segundo paso.
  \\item Tercer paso.
...
\begin{enumerate}
  \\item Descargar el código fuente del repositorio.
  \\item Instalar las dependencias necesarias.
  \\item Configurar las variables de entorno.
  \\item Ejecutar el script de inicialización.
  \\item Verificar que todo funciona correctamente.
\end{enumerate}
...
\begin{codigosimple}{latex}{Sintaxis: Badge personalizado}
...
\begin{codigosimple}{latex}{Sintaxis: Badges predefinidos}
...
\begin{codigosimple}{latex}{Sintaxis: Indicador de versión}
...
\begin{codigosimple}{latex}{Sintaxis: Barra de progreso}
...
\begin{codigosimple}{latex}{Sintaxis: Rating con estrellas}
...
\begin{codigosimple}{latex}{Sintaxis: Indicador de nivel}
...
\begin{codigosimple}{latex}{Sintaxis: personcard}
...
\begin{codigosimple}{latex}{Sintaxis: statcard}
...
\begin{codigosimple}{latex}{Sintaxis: Timeline}
\begin{timeline}
...
\begin{codigosimple}{latex}{Sintaxis: Comparativas}
...
\begin{codigosimple}{latex}{Sintaxis: Citas Destacadas}
...
\begin{codigosimple}{latex}{Sintaxis: Componentes de Software}
...
\begin{codigosimple}{latex}{Sintaxis: API REST Endpoints}
...
\begin{codigosimple}{latex}{Sintaxis: Badges de métodos HTTP}
...
\begin{codigosimple}{latex}{Sintaxis: Terminal y Consola}
...
\begin{codigosimple}{latex}{Sintaxis: Árbol de Directorios}
...
\begin{codigosimple}{latex}{Sintaxis: Clase}
...
\begin{codigosimple}{latex}{Sintaxis: Interfaz}
...
\begin{codigosimple}{latex}{Sintaxis: Tabla de Requisitos}
\begin{requirements}
...
\begin{codigosimple}{latex}{Sintaxis: Esquema de Base de Datos}
...
\begin{codigosimple}{latex}{Sintaxis: Commits}
...
\begin{codigosimple}{latex}{Sintaxis: Ramas y etiquetas}
...
\begin{codigosimple}{latex}{Sintaxis: logbox}
\begin{logbox}[Título]
...
Muestra un valor con etiqueta, variación y un icono indicador.

\begin{codigosimple}{latex}{Sintaxis: metricbox}
\metricbox{Etiqueta}{valor}{variación}{\faArrowDown}
\end{codigosimple}

\vspace{1em}
\noindent
\metricbox{Tiempo de respuesta}{45 ms}{-12\%}{\faArrowDown}
\hfill
\metricbox{Uso de CPU}{78\%}{+5\%}{\faArrowUp}
\hfill
\metricbox{Memoria}{2.4 GB}{-0.3 GB}{\faArrowDown}
...
\begin{codigosimple}{latex}{Sintaxis: Componentes de Telecomunicaciones}
...
\begin{codigosimple}{latex}{Sintaxis: Carta de Smith}
...
\begin{codigosimple}{latex}{Sintaxis: Diagrama de Constelación}
...
\begin{codigosimple}{latex}{Sintaxis: Máquina de Estados Finitos}
\begin{fsmdiagram}
...
\begin{codigosimple}{latex}{Sintaxis: Sintaxis básica}
...
\begin{codigosimple}{latex}{Sintaxis: Campo multi-fila}
...
\begin{codigosimple}{latex}{Sintaxis: Campos con continuación}
...
\begin{codigosimple}{latex}{Sintaxis: Etiqueta externa forzada}
...
\begin{codigosimple}{latex}{Sintaxis: Campos reservados y agrupación}
...
\begin{codigosimple}{latex}{Sintaxis: Parámetros S}
...
\begin{codigosimple}{latex}{Sintaxis: Diagramas de Bloques}
\begin{blockdiagram}
...
\begin{codigosimple}{latex}{Sintaxis: Diagramas de Temporización}
...
\begin{codigosimple}{latex}{Sintaxis: Componentes de Arquitectura}
...
\begin{codigosimple}{latex}{Sintaxis: Diagrama de Gantt}
...
\begin{codigosimple}{latex}{Sintaxis: techsheet}
...
\begin{codigosimple}{latex}{Sintaxis: materialcard}
...
\begin{codigosimple}{latex}{Sintaxis: Presupuestos}
\begin{presupuesto}
...
\begin{codigosimple}{latex}{Sintaxis: Normativa Aplicable}
\begin{normativa}
...
\begin{codigosimple}{latex}{Sintaxis: Control de Calidad}
...
\begin{codigosimple}{latex}{Sintaxis: Etiquetas Energéticas}
...
\begin{codigosimple}{latex}{Sintaxis: Certificaciones}
...
\begin{codigosimple}{latex}{Sintaxis: Componentes de Química}
...
\begin{codigosimple}{latex}{Sintaxis: reactionbox}
...
\begin{codigosimple}{latex}{Sintaxis: mechanismbox}
...
\begin{codigosimple}{latex}{Sintaxis: compoundsheet}
...
\begin{codigosimple}{latex}{Sintaxis: compoundcard}
...
\begin{codigosimple}{latex}{Sintaxis: Protocolos de Laboratorio}
...
\begin{codigosimple}{latex}{Sintaxis: Resultados Analíticos}
...
\begin{codigosimple}{latex}{Sintaxis: equipmentlist}
\begin{equipmentlist}
...
\begin{codigosimple}{latex}{Sintaxis: reagentlist}
\begin{reagentlist}
...
\begin{codigosimple}{latex}{Sintaxis: Componentes de Geología}
...
\begin{codigosimple}{latex}{Sintaxis: Columna Estratigráfica}
...
\begin{codigosimple}{latex}{Sintaxis: mineraltable}
\begin{mineraltable}
...
\begin{codigosimple}{latex}{Sintaxis: mineralcard}
...
\begin{codigosimple}{latex}{Sintaxis: geotechdata}
\begin{geotechdata}
...
\begin{codigosimple}{latex}{Sintaxis: Valores característicos}
...
\begin{codigosimple}{latex}{Sintaxis: Clasificación de Suelos}
...
\begin{codigosimple}{latex}{Sintaxis: Eras Geológicas}
\geoera{nombre}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: Riesgos Geológicos}
...
\begin{codigosimple}{latex}{Sintaxis: Símbolos Geológicos}
...
\begin{codigosimple}{latex}{Sintaxis: Componentes de Prevención}
...
\begin{codigosimple}{latex}{Sintaxis: Matriz de Riesgos}
...
\begin{codigosimple}{latex}{Sintaxis: Evaluación de Riesgos}
...
\begin{codigosimple}{latex}{Sintaxis: Checklist de Seguridad}
...
\begin{codigosimple}{latex}{Sintaxis: Señalización de Seguridad}
...
\begin{codigosimple}{latex}{Sintaxis: Equipos de Protección Individual}
\begin{epilist}
...
\begin{codigosimple}{latex}{Sintaxis: Indicadores de Seguridad}
...
\begin{codigosimple}{latex}{Sintaxis: Procedimiento de Emergencia}
...
\begin{emergencyprocedure}[En caso de accidente grave]
  \begin{enumerate}
  \\item Proteger: Asegurar la zona y evitar nuevos accidentes.
  \\item Avisar: Llamar al 112 y comunicar a los servicios de emergencia.
  \\item Socorrer: Aplicar primeros auxilios si se tiene formación.
  \\item No mover al accidentado salvo peligro inminente.
  \\item Esperar a los servicios de emergencia.
\end{enumerate}
...
\begin{codigosimple}{latex}{Sintaxis: Registro de Formación}
...
\begin{codigosimple}{latex}{Sintaxis: Informe de Accidente}
