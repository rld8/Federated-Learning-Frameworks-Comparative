...
heterogeneidad de datos y clientes. El Capítulo~\ref{chap:estado-arte} revisa el panorama
de herramientas disponibles y justifica la selección de los \textit{frameworks}
comparados. El Capítulo~\ref{chap:metodologia} describe la metodología experimental: el
marco de evaluación en tres ejes —rendimiento, usabilidad y flexibilidad—, el control
de variables, la reproducibilidad, las métricas empleadas y el alcance y las
limitaciones del trabajo. El Capítulo~\ref{chap:experimentos} concreta
el escenario común a las tres herramientas, la matriz de experimentos y los modos de
ejecución secuencial y concurrente. El Capítulo~\ref{chap:resultados} presenta los
resultados de los tres ejes y su análisis comparativo entre \textit{frameworks}. Por
último, el Capítulo~\ref{chap:conclusiones} recapitula la consecución de los objetivos, las
aportaciones, las limitaciones y las líneas de trabajo futuro.
